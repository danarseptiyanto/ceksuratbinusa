            ...
            <div className="flex justify-center border-b">
                <div className="mx-5 flex w-full max-w-screen-xl justify-center border-x px-14 py-8">
                    <div className="text-sm">
                        ...
                        di SMK Bina Nusantara. Source code tersedia di{" "}
                        <a
                            href="https://github.com/danarseptiyanto/ceksuratbinusa"
                            className="font-semibold underline underline-offset-4"
                            target="_blank"
                        >
                            GitHub
                    ...
                    <div className="flex gap-2">
                        <a href="#" target="_blank" rel="noopener noreferrer">
                            <Button
                                variant="outline"
                                size="icon"
                                className="h-8 w-8 rounded-full transition-colors hover:bg-primary hover:text-white"
                            >
                                <svg
